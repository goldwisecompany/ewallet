...
const PrivacyPolicyScreen = ({navigation, route, myWallets, current}) => {
  return (
    <ScrollView style={styles.container}>
      <View style={{margin: 20}}>
        ...
        <Text>
          ...
          device identifiers and other diagnostic data. Tracking & Cookies Data
        ...
        <Text style={{fontWeight: '700', fontSize: 20}}>Transfer Of Data</Text>
        <Text>
          Your information, including Personal Data, may be transferred to — and
          maintained on — computers located outside of your state, province,
          country or other governmental jurisdiction where the data protection
          laws may differ than those from your jurisdiction. If you are located
          outside Taiwan and choose to provide information to us, please note
        ...
        <Text style={{fontWeight: '700', fontSize: 20}}>Security Of Data</Text>
        <Text>
        ...
        <Text style={{fontWeight: '700', fontSize: 20}}>Service Providers</Text>
        <Text>
          ...
          Service. Google Analytics Google Analytics is a web analytics service
          ...
          https://policies.google.com/privacy?hl=en Amplitude Amplitude is
          analytics service provided by Amplitude, Inc. You can visit their
          Privacy Policy page here: https://amplitude.com/privacy
        </Text>
        <Text style={{fontWeight: '700', fontSize: 20}}>
